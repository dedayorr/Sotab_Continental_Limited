...
import { X, ChevronLeft, ChevronRight, Play, Camera, Video, Grid3x3, MapPin, Home, Maximize2 } from "lucide-react";

const galleryItems = [
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Aerial masterplan view", category: "Masterplan", location: "Full Estate View" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Professional soccer pitch", category: "Amenities", location: "Sports Complex" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "FIFA-standard football field", category: "Amenities", location: "Football Arena" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Multi-sport basketball court", category: "Amenities", location: "Basketball Court" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Grand estate entrance", category: "Entrance", location: "Main Gate" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Luxury entrance detail", category: "Entrance", location: "Security Gate" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Estate entrance architecture", category: "Entrance", location: "Welcome Center" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Contemporary 5-bedroom duplex", category: "Residences", location: "Villa Section A" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Modern luxury duplex exterior", category: "Residences", location: "Villa Section B" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Premium duplex architecture", category: "Residences", location: "Villa Section C" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Tree-lined boulevard", category: "Infrastructure", location: "Main Boulevard" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Complete estate overview", category: "Masterplan", location: "Development Layout" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Premium sports facilities", category: "Amenities", location: "Recreation Area" },
  { type: "image", src: "/api/placeholder/1920/1080", alt: "Exclusive corner residence", category: "Residences", location: "Premium Plot" },
];

const categories = ["All", "Masterplan", "Residences", "Amenities", "Entrance", "Infrastructure"];
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50">
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
            {categories.map((category) => (
              <button
                ...
                style={
                  filter === category
                    ? { background: "linear-gradient(135deg, #1f3693 0%, #771933 100%)" }
                    : {}
                }
              >
                {category}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        {filteredItems.length === 0 ? (
          <div className="text-center py-20">
            <Camera className="w-16 h-16 mx-auto mb-4" style={{ color: "#1f3693" }} />
              ...
              >
                ...
                <div className="relative aspect-4/3 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 p-2 rounded-full opacity-0 group-hover:opacity-100 transform scale-0 group-hover:scale-100 transition-all duration-300">
                    <Maximize2 className="w-5 h-5" style={{ color: "#1f3693" }} />
                  </div>
                  ...
                  {item.type === "video" && (
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="bg-white/95 rounded-full p-5 group-hover:scale-110 transition-all duration-300 shadow-xl">
                        <Play className="w-10 h-10" style={{ color: "#771933" }} fill="currentColor" />
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div
                  ...
                  style={{ background: "linear-gradient(90deg, #1f3693 0%, #771933 100%)" }}
                />
              </div>
            ))}
          </div>
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #282b53 0%, #1f3693 100%)" }}
      >
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 text-gray-300">
                    ...
                    <span className="text-lg">{filteredItems[currentIndex].location}</span>
                  </div>
                </div>
